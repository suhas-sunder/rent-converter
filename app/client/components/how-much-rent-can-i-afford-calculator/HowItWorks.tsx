...
const howItWorks = {
  ...
  intro: "Use income, target rent, and rent-to-income rules as a starting point for a realistic rent budget. The useful question is not only the maximum number, but what the rent leaves behind for everything else.",
  steps: [
    {
