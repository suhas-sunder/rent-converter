...
const howItWorks = {
  title: "Monthly to daily rent conversion",
  intro: "A monthly-to-daily conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the daily equivalent means",
      body: "It answers: if $2,000.00 per month continued across the year, what would that look like per day? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing a monthly quote with a daily budget",
      body: "$2,000.00 per month is about $65.75 per day. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
    ...
    },
    {
      ...
      body: "If a listing looks cheaper only because it is quoted monthly, convert it before comparing it with daily rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
