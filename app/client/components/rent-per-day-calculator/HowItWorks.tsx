            ...
            <div className="relative overflow-hidden rounded-3xl bg-slate-900 text-white p-6 sm:p-7">
              ...
              <div className="relative">
                ...
                <p className="mt-3 text-slate-200 leading-7">
                  Outputs are consistent comparisons derived from fixed time
                  assumptions. They support decisions like “which listing is
                  cheaper per day,” “what is the implied yearly cost,” and “what
                  does this rate mean over N days.” They do not model lease
                  proration rules, due dates, partial-period billing, deposits,
                  or fees.
                </p>
              </div>
            </div>
