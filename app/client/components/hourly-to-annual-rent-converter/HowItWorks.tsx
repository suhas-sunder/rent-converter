...
const howItWorks = {
  title: "Hourly to annual rent conversion",
  intro: "An hourly-to-annual conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the annual equivalent means",
      body: "It answers: if $25.00 per hour continued across the year, what would that look like per year? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing an hourly quote with an annual budget",
      body: "$25.00 per hour is about $219,000.00 per year. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
      title: "Checking annual pressure",
      body: "The same rent is about $219,000.00 per year. Annualizing is useful when two options use different billing cycles but both affect the same yearly budget."
    },
    {
      title: "Avoiding a false bargain",
      body: "If a listing looks cheaper only because it is quoted hourly, convert it before comparing it with annual rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
