              ...
              <div className="p-5 sm:px-6">
                ...
                <div className="mt-4 space-y-3">
                  <p>
                    ...
                    represents the same annual cost spread across 14-day blocks
                  ...
                  <p>
                    ...
                    uses the same day-based model so the table stays internally
                    consistent (annual ↔ weekly ↔ daily ↔ hourly, etc.)
                    without mixing “twice a month” assumptions into the math.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative rounded-3xl bg-white ring-1 ring-slate-200/80 shadow-sm">
              ...
              <div className="p-5 sm:px-6">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <p>
                    You may also see references to “26 payments.” That number is
                    sometimes used as a schedule shorthand (52 weeks ÷ 2), but
                    it is not the conversion rule on this tool. The conversion
                    is based on time length, not assumed payment counts.
                  </p>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl bg-white ring-1 ring-slate-200/80 p-5">
                      ...
                      <p className="mt-2">
                        Uses 14-day blocks across a 365-day year. This produces
                        a stable, comparable biweekly equivalent.
                      </p>
                    </div>
                    <div className="rounded-2xl bg-white ring-1 ring-slate-200/80 p-5">
                      <div className="text-sm font-bold text-slate-900">
                      ...
                      <p className="mt-2">
                        “× 26” can be shown as a reference point only. It is not
                        used as the primary conversion.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-5 sm:px-6">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <p>
                    ...
                    guessing and producing a clean-looking but incorrect result.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl bg-white ring-1 ring-slate-200/80 p-5">
                      ...
                      <p className="mt-2">
                        If you need other directions, use the general converter
