...
const howItWorks = {
  title: "Annual to biweekly rent conversion",
  intro: "An annual-to-biweekly conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the biweekly equivalent means",
      body: "It answers: if $24,000.00 per year continued across the year, what would that look like per two weeks? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing an annual quote with a biweekly budget",
      body: "$24,000.00 per year is about $920.55 per two weeks. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
    ...
    },
    {
      ...
      body: "If a listing looks cheaper only because it is quoted annually, convert it before comparing it with biweekly rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
