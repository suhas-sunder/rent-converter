...
const howItWorks = {
  title: "Rent compared with after-tax income",
  intro: "Comparing rent with take-home income can be more honest than using gross salary because it reflects the money actually available after taxes and deductions.",
  steps: [
    {
