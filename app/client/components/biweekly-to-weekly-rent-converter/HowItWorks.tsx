...
const howItWorks = {
  title: "Biweekly to weekly rent conversion",
  intro: "A biweekly-to-weekly conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the weekly equivalent means",
      body: "It answers: if $1,000.00 per two weeks continued across the year, what would that look like per week? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing a biweekly quote with a weekly budget",
      body: "$1,000.00 per two weeks is about $500.00 per week. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
    ...
    },
    {
      ...
      body: "If a listing looks cheaper only because it is quoted biweekly, convert it before comparing it with weekly rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
