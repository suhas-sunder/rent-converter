...
const howItWorks = {
  title: "Rent after increase",
  intro: "Use a known rent increase to calculate the new rent after one change. This is helpful when you have the current rent and either a fixed dollar increase or a percentage increase.",
  steps: [
    {
