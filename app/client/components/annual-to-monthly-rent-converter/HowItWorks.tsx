...
const howItWorks = {
  title: "Annual to monthly rent conversion",
  intro: "An annual-to-monthly conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the monthly equivalent means",
      body: "It answers: if $24,000.00 per year continued across the year, what would that look like per month? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing an annual quote with a monthly budget",
      body: "$24,000.00 per year is about $2,000.00 per month. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
    ...
    },
    {
      ...
      body: "If a listing looks cheaper only because it is quoted annually, convert it before comparing it with monthly rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
