...
const howItWorks = {
  title: "Monthly to weekly rent conversion",
  intro: "A monthly-to-weekly conversion helps when one rent number is quoted on a different time basis than the number you budget with. The result is an equivalent rent amount for comparison, not a rewrite of the lease payment schedule.",
  steps: [
    {
      title: "What the weekly equivalent means",
      body: "It answers: if $2,000.00 per month continued across the year, what would that look like per week? That makes unlike rent quotes easier to compare side by side."
    },
    {
  ...
  examples: [
    {
      title: "Comparing a monthly quote with a weekly budget",
      body: "$2,000.00 per month is about $460.27 per week. That gives you a cleaner way to compare a listing with your normal budget period."
    },
    {
    ...
    },
    {
      ...
      body: "If a listing looks cheaper only because it is quoted monthly, convert it before comparing it with weekly rent. The period label can hide the real cost difference."
    }
  ],
  notes: [
