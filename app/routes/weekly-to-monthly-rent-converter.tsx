...
export const meta: Route.MetaFunction = () => {
  ...
  return [
    ...
    },
    {
      name: "keywords",
      content:
        "weekly to monthly rent, convert weekly rent to monthly, weekly rent monthly equivalent, 4 week rent vs monthly, 28 day rent vs monthly",
    },
...
export default function WeeklyToMonthlyRent() {
  ...
  const faqData = [
    {
      ...
      a: "Convert the weekly rent to an annual amount, then divide by 12. This gives a calendar-month estimate instead of simply multiplying weekly rent by 4.",
    },
    {
    ...
    },
    {
      ...
      a: "No. It gives a rent conversion estimate. Exact payments can depend on lease wording, due dates, proration rules, fees, and local billing practices.",
    },
    {
  ...
  const amountInputId = "rc-wtm-weekly-rent";
  const amountHelpId = "rc-wtm-weekly-rent-help";
  const amountErrorId = "rc-wtm-weekly-rent-error";
  const currencySelectId = "rc-wtm-currency";
