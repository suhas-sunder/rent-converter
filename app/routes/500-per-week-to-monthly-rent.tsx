...
export const meta: Route.MetaFunction = () => {
  ...
  return [
    { title: "Free 500 Weekly/Monthly Rental Rate Calculator" },
    {
      name: "description",
      content:
        "Convert 500 per week to rent per calendar month. See the weekly to monthly rent formula and instant monthly equivalent.",
    },
    { name: "robots", content: "index,follow" },
    { property: "og:type", content: "website" },
    {
      property: "og:title",
      content: "Free 500 Weekly/Monthly Rental Rate Calculator",
    },
    {
      property: "og:description",
      content:
        "Easily convert 500 per week to rent per calendar month using the standard weekly to monthly rent formula.",
    },
    ...
    },
    {
      ...
      content:
        "Convert 500 per week to monthly rent instantly with a simple weekly/monthly rental rate calculator.",
    },
        ...
        <div className="rounded-2xl pb-6 bg-white sm:shadow-sm sm:border border-slate-200 sm:px-8">
          <div className="pt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h1 className="text-center mb-1 sm:mb-0 sm:text-left text-2xl sm:text-3xl capitalize font-bold text-sky-800 tracking-tight">
              500 per Week to Monthly Rent (Exact Conversion)
            </h1>
          </div>
