...
export const meta: Route.MetaFunction = () => {
  const title = "Biweekly to Weekly Rent Converter | Rent Calculator";
  const description =
    "Convert biweekly rent to weekly rent. See the weekly amount, related breakdowns, and export options.";
