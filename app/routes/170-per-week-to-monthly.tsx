...
export const meta: Route.MetaFunction = () => {
  ...
  return [
    { title: "Free 170 Weekly/Monthly Rental Rate Calculator" },
    {
      name: "description",
      content:
        "Convert 170 per week to rent per calendar month. See the weekly to monthly rent formula and instant monthly equivalent.",
    },
    { name: "robots", content: "index,follow" },
    { property: "og:type", content: "website" },
    {
      property: "og:title",
      content: "Free 170 Weekly/Monthly Rental Rate Calculator",
    },
    {
      property: "og:description",
      content:
        "Easily convert 170 per week to rent per calendar month using the standard weekly to monthly rent formula.",
    },
    ...
    },
    {
      ...
      content:
        "Convert 170 per week to monthly rent instantly with a simple weekly/monthly rental rate calculator.",
    },
      ...
      <section className="mx-auto max-w-6xl px-6 pb-6 mt-2 sm:mt-6">
        <div className="rounded-2xl pb-6 bg-white sm:shadow-sm sm:border border-slate-200 sm:px-8">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-[#f7fbff] p-4 sm:px-6">
            <div className="text-xs font-semibold uppercase tracking-wide text-slate-170">
            ...
            <div className="mt-1 text-xs text-slate-170">
              Based on annual equivalence (365-day year)
            </div>

            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
                <div className="text-xs text-slate-170">4 weeks (28 days)</div>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="cursor-pointer rounded-lg border border-slate-300 bg-white px-2 py-1 text-xs font-semibold outline-none focus:border-sky-170 focus:ring-2 focus:ring-sky-100"
                >
