    ...
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-slate-50 text-slate-700 scroll-smooth">
      ...
      <section id="converter" className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="overflow-hidden rounded-[1.75rem] bg-white px-5 pb-6 sm:px-8">
            ...
            <div className="md:col-span-6">
              ...
              <div className="grid grid-cols-12 gap-2">
                <input
                  ...
                  className="col-span-7 rounded-xl bg-slate-100 px-4 py-2 text-base text-slate-950 placeholder:text-slate-700 outline-none focus:bg-white focus:ring-2 focus:ring-sky-200"
                ...
                <select
                  ...
                  className="cursor-pointer col-span-5 rounded-xl bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-950 outline-none transition hover:bg-sky-50 focus:bg-white focus:ring-2 focus:ring-sky-200 focus-visible:ring-2 focus-visible:ring-sky-400"
              ...
              {mode === "percent" ? (
                <div className="grid grid-cols-12 gap-2">
                  <input
                    ...
                    className="col-span-8 rounded-xl bg-slate-100 px-4 py-2 text-base text-slate-950 placeholder:text-slate-700 outline-none focus:bg-white focus:ring-2 focus:ring-sky-200"
                ...
                <div className="grid gap-2">
                  <input
                    ...
                    className="rounded-xl bg-slate-100 px-4 py-2 text-base text-slate-950 placeholder:text-slate-700 outline-none focus:bg-white focus:ring-2 focus:ring-sky-200"
              ...
              {!computed.ok ? (
                ...
                <>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-2xl bg-white px-4 py-3">
                      <div className="text-xs text-slate-700">Annual after</div>
                      <div className="mt-1 text-lg font-bold text-slate-950">
                        {fmtMoney(computed.annualNewScaled)}
                      </div>
                    </div>

                    <div className="sm:col-span-2 lg:col-span-3 rounded-2xl bg-white p-4">
                  ...
                  <div className="mt-6 rounded-[1.5rem] bg-white p-5 sm:p-6 rc-print-block">
          ...
          <div className="mt-4 rounded-xl bg-sky-100 px-4 py-3 text-sm text-slate-700">
            <div className="font-semibold text-slate-950">
              Assumptions used on this page
            </div>
            <ul className="mt-1 list-disc pl-5 space-y-1 text-xs text-slate-700">
