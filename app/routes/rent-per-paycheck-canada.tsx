...
export default function RentPerPaycheckCanada() {
  ...
  const monthlyRentInputId = "rc-rpc-ca-monthly-rent";
  const currencySelectId = "rc-rpc-ca-currency";
  const payPeriodSelectId = "rc-rpc-ca-pay-period";
  const amountHelpId = "rc-rpc-ca-monthly-rent-help";
  const amountErrorId = "rc-rpc-ca-monthly-rent-error";
