...
export const meta: Route.MetaFunction = () => {
  ...
  const description =
    "Convert hourly rent to a monthly equivalent using annual equivalence (365-day year). Decimal-safe input, full period breakdown, and month-length comparison.";
