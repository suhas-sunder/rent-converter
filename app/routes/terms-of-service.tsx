...
export const meta: Route.MetaFunction = () => {
  ...
  return [
    ...
    { property: "og:site_name", content: "RentConverter" },
    { property: "og:title", content: title },
    { property: "og:description", content: description },
    { property: "og:type", content: "website" },
    { property: "og:url", content: canonical },
    { property: "og:image", content: ogImage },
    { property: "og:image:alt", content: "RentConverter terms of service" },
    ...
    <main className="mx-auto max-w-[1200px] px-6 py-10 text-slate-700">
      ...
      <div className="flex flex-col gap-8 leading-relaxed">
        <section className="flex flex-col gap-4">
          ...
          <p>
            We are RentConverter (https://www.rentconverter.com) ("Company",
            "we", "us", "our").
          </p>

          <p>
            We operate the website https://www.rentconverter.com (the "Site"),
          ...
          <p>
            You can contact us by email at admin@rentconverter.com or by mail to
            https://www.rentconverter.com, Toronto, Ontario, Canada.
          </p>

          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and RentConverter, concerning your access to and use of the
