...
export default function OneEightyPerWeekToMonthlyRent() {
  ...
  const webPageSchema = {
    ...
    "@type": "WebPage",
    name: "$180 Per Week to Monthly Rent",
    description:
      "Convert $180 per week to monthly rent using annual equivalence and compare it with a simple 4-week rent calculation.",
    url: pageUrl,
    isPartOf: {
      "@type": "WebSite",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How much is $180 per week per month?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "$180 per week is about $782.14 per calendar month using annual equivalence: weekly rent multiplied by 365, divided by 7, then divided by 12.",
        },
      },
      {
        "@type": "Question",
        name: "Why is $180 per week not just $720 per month?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "$720 is four weeks of rent, but most calendar months are longer than exactly four weeks. A calendar-month equivalent spreads weekly rent across the full year and divides it by 12.",
        },
      },
      {
        "@type": "Question",
